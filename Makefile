...
venv: ## Create the dev venv and install the package editable (httpx + PyYAML aren't stdlib).
...
test-live: venv ## Opt-in: hit the real Monad LiteLLM endpoint end-to-end (needs the scoped key).
